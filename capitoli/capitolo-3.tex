...
\begin{itemize}
	...
	\item \textbf{Terza settimana}: Ottimizzazione del sito tramite implementazione della cache delle query. Studio e progettazione dell'aggiunta delle tariffe vuoto per pieno al flusso dati del Booking Engine;
