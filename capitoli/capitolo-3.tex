...
\begin{itemize}
	\item \textbf{Prima settimana}: formazione sulle tecnologie utilizzate dal \bookingEngine CrociereRegalo, con particolare attenzione alla libreria \textit{Codeigniter} e al DBMS \textit{Microsoft SQL Server};
