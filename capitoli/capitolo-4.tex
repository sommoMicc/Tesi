...
\begin{center}
	...
	\begin{longtable}{ >{\raggedright}p{5.5cm} p{6.8cm}} 
		...
		\hline
		- callWS (xml: string, function: string) : string & Fa una richiesta al \gls{webservice}, chiamando la procedura remota \textit{function}, utilizzando come payload il valore del parametro \textit{xml}. Restituisce la risposta del \gls{webservice} come stringa.\\
		\hline
